  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { title: "Everything PR News | Public Relations & Marketing" },
        ...
        { property: "og:title", content: "Everything PR News | Public Relations & Marketing" },
        { property: "og:type", content: "website" },
        { name: "twitter:card", content: "summary" },
        { name: "twitter:title", content: "Everything PR News | Public Relations & Marketing" },
